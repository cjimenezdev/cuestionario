...
let canvas, canvasDiv, canvasWidth, canvasHeight, mindmap, input, newText, menu, backgroundColor, imgFondo;
...
class MindMap {
    ...
    new() {
        ...
        this.colorFor = null;
        this.name = "";
        this.backgroundColor = "rgb(0, 123, 255)";
        this.settingsFor = "keyword";
        this.imgSource = "";
    }
    open() {
...
function setup() {
    // Setting the resource of the img as background
    imgFondo = loadImage("images/2.jpg");
    canvasHeight = 640;
